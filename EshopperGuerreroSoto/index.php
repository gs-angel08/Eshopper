...
<head>
    ...
    <meta name="Guerrero Angel" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 840 9621</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> guerrerosotoangeldavid@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
								...
								<div class="single-products">
										<div class="productinfo text-center">
											<?php
											  ...
											  ?>
											<img src="images/home/<?php echo $img;?>.jpg".alt="" width="210" height="150" alt=""/>
